    ...
    public static class Info
    {
        ...
        public static string GetUsageInfo()
            => "Usage:" + Environment.NewLine
               ...
               + "Delete all files with a modified date older than 7 days from the folder and it's sub-folders" + Environment.NewLine
               + "\t" + EXE_NAME + " \"c:\\SomeFolder\\withOldFiles\" -d 7 --modified" + Environment.NewLine

               + Environment.NewLine

               + "Delete all files with a created date older than 7 days from the folder and it's sub-folders" + Environment.NewLine
               ...
               + "\t" + EXE_NAME + " \"c:\\SomeFolder\\withOldFiles\" -d 7  [--modified|--created] --allEmptyFolders" + Environment.NewLine

                + Environment.NewLine

                + "Delete all files older than(modified|created)  7 days from the folder and it's sub-folders " + Environment.NewLine
                + "AND delete any folders that don't have files in anymore" + Environment.NewLine
                + "\t" + EXE_NAME + " \"c:\\SomeFolder\\withOldFiles\" -d 7  [--modified|--created] --emptiedFolders" + Environment.NewLine;
    }
